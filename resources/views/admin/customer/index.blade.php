        ...
        <tbody>
            @foreach ($customer as $item)
                <tr>
                    ...
                    <td>
                        <a href="{{route('admin.customer.edit',$item->id)}}" class="btn btn-sm btn-warning shadow"><i class="fas fa-edit"></i></a>
                        <a href="{{route('admin.customer.delete',$item->id)}}" class="btn btn-sm btn-danger shadow"><i class="fas fa-trash"></i></a>
                    </td>
                </tr>
            @endforeach
        </tbody>
